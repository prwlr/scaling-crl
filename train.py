...
class Args:
    ...
    actor_depth: int = 4
    critic_depth: int = 4
    # 0 for no skip connections, >= 0 means the frequency of skip connections (every N layers)
...
if __name__ == "__main__":
    ...
    def update_actor_and_alpha(transitions, training_state, key):
        ...
        def actor_loss(actor_params, critic_params, log_alpha, transitions, key):
            ...
            sa_encoder_params, g_encoder_params = \
                critic_params["sa_encoder"], critic_params["g_encoder"]
    ...
    def training_step(training_state, env_state, buffer_state, key, t):
        experience_key1, experience_key2, sampling_key, training_key, sgd_batches_key = \
